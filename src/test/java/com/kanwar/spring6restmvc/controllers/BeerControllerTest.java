...
import com.kanwar.spring6restmvc.services.BeerServiceImpl;
...
class BeerControllerTest {
    ...
    public void populateData(){
        ...
        beers = beerServiceImpl.getAllBeers();
    }
    ...
    void testCreateNewBeer() throws Exception {
        ...
        given(beerService.createNewBeer(any(Beer.class))).willReturn(newBeer);
        ...
        verify(beerService).createNewBeer(beerArgumentCaptor.capture());

        assertThat(beerArgumentCaptor.getValue()).isEqualTo(newBeer);
    }
